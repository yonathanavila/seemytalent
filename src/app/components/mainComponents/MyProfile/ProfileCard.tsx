...
const ProfileCard: React.FC<{
    ...
    return (
        <div className={`${className} relative group`}>
            <div className={`${onlyRead && 'transition-opacity duration-300 ease-in-out hover:opacity-75 hover:cursor-pointer'}`}>
                ...
                <CustomCard className="dark:bg-[#131A2A]">
                    ...
                    {onlyRead && (
                        <div className="group-hover:animate-pulse absolute bottom-0 left-0 w-full lg:py-2 sm:mt-4 dark:bg-gray-800 dark:text-white text-center rounded-lg opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100 h-[20px]" />
                    )}
