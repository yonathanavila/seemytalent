...
export interface IDetail { id?: string; personalInformation: IPersonalInformation; education: Array<IEducation>; workExperience: Array<IWorkExperience>; skills: Array<ISkill>; projects: Array<IProject>; }
